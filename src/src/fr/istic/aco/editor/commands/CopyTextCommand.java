...
/**
 * The {@code CopyTextCommand} class implements the functionality for copying the
 * currently selected text into the clipboard.
 */
public class CopyTextCommand implements CommandOriginator
{
     ...
     */
    public CopyTextCommand(Engine engine, Recorder recorder, UndoManager undoManager){
        this.engine=engine;
